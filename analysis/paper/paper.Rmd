...
When focusing on the field of archaeology, we can see that gender imbalance still occurs in archaeology and that seems to impact the kind of publications that are done in the field [@bardolph2014critical]. <!--- something about increasing numbers of women's with PhD and increasing rates of participation -->
