...
SAA16 <- readxl::read_excel("SAA2016.xlsx")
SAA17 <- readxl::read_excel("SAA2017.xlsx")
SAA18 <- readxl::read_excel("SAA2018-finalprogram.xlsx")
SAA19 <- readxl::read_excel("SAA2019.xlsx")
EAA18 <- readxl::read_excel("2018 EAA.xlsx")
CAA18 <- readxl::read_excel("2018 CAA.xlsx")
SAA18_top_term_plot <- readRDS("SAA18 top term plot")
