...
Our results show correlations between the gender of the first-named presenter and the topics in their conference presentation. Although each of the three meetings have distinctive sets of topics, we can identify some common themes in the topics that correlate with 
