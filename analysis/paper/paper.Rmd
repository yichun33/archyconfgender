...
Our results show significant correlations between the gender of the first-named presenter and the topics in their conference presentation in all three conferences. Although each of the three meetings have distinctive sets of topics, we can identify some common themes in the topics that correlate with gender. 
