...
ggplot2::ggsave(here::here("analysis/figures/fig_1_basic_info_papers_per_conf.tiff"), 
       height = 4, 
       width = 6,
       dpi = 600,
       bg = "white")
...
# https://www.tandfonline.com/action/authorSubmission?show=instructions&journalCode=yjfa20
he = 4.5
wi = 7
dpi = 800
plot_file_format <-  "tiff"
...
SAA18_stm_plot$plot
ggplot2::ggsave(here::here(paste0("analysis/figures/fig_2_SAA18_stm_plot.",
                                  plot_file_format)), 
       height = he, 
       width = wi,
       dpi = dpi)
...
EAA18_stm_plot$plot
ggsave(here::here(paste0("analysis/figures/fig_3_EAA18_stm_plot.", 
                  plot_file_format)),
       height = he, 
       width = wi,
       dpi = dpi)
...
# CAA18_stm_plot$plot
# dissemble the plot to remove the tofu text
q <- ggplot_build(CAA18_stm_plot$plot)
q$data[[7]]$label[14] <- str_remove_all(q$data[[7]]$label[14], "���,")
# reassemble the plot
p <- ggplot_gtable(q)
# show the plot
plot(p)
ggsave(here::here(paste0("analysis/figures/fig_4_CAA18_stm_plot.", 
                         plot_file_format)),
       height = he, 
       width = wi,
       dpi = dpi)
